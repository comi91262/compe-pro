...
func TestInsertionSort3(t *testing.T) {
	a := []int{1, 3, 13, 76, 99, 8, 16, 3}
	insertionSort(a, 0, len(a)-1)
	want := []int{1, 3, 3, 8, 13, 16, 76, 99}
	if !testEqSlice(a, want) {
		t.Errorf("Error: %v", a)
	}
}
...
func TestQuickSelect(t *testing.T) {
	...
	got := QuickSelect(a, 0, len(a)-1, 15)
...
func TestQuickSelect2(t *testing.T) {
	a := []int{3, 77, 22, 40, 21, 32, 76, 58, 89, 64, 24, 30, 35, 27, 61, 91}
	b := make([]int, len(a))
	copy(b, a)
	sort.Ints(b)
...
func TestQuickSelect23(t *testing.T) {
	a := []int{1, 3, 13, 76, 99, 8, 16, 20, 25, 37, 7, 22, 28, 30, 47, 40, 43, 49, 52, 57, 5, 37, 70, 75, 85, 23, 33, 50, 77}
	b := make([]int, len(a))
	copy(b, a)
	sort.Ints(b)
